...
public class TestStrictBankAccount {
    ...
    public void setUp() {
        ...
        this.accountRossi = new StrictBankAccount(aRossi, 0.0);
        this.accountBianchi = new StrictBankAccount(aBianchi, 0.0);
    }
    ...
    public void testDepositFromATM() {
        ...
        Assertions.assertEquals(accountRossi.getBalance(), 1000 - StrictBankAccount.ATM_TRANSACTION_FEE);
        Assertions.assertEquals(accountBianchi.getBalance(), 1000 - StrictBankAccount.ATM_TRANSACTION_FEE);
        accountRossi.deposit(1, depositNegative);
        accountBianchi.deposit(2, depositNegative);
        Assertions.assertEquals(accountRossi.getBalance(), 1000 - StrictBankAccount.ATM_TRANSACTION_FEE);
        Assertions.assertEquals(accountBianchi.getBalance(), 1000 - StrictBankAccount.ATM_TRANSACTION_FEE);
        accountRossi.deposit(2, depositPositive);
        accountBianchi.deposit(1, depositPositive);
        Assertions.assertNotEquals(accountRossi.getBalance(), 2000 - 2 * StrictBankAccount.ATM_TRANSACTION_FEE);
        Assertions.assertNotEquals(accountBianchi.getBalance(), 2000 - 2 * StrictBankAccount.ATM_TRANSACTION_FEE);
        Assertions.assertEquals(accountRossi.getTransactionsCount(), 1);
        Assertions.assertEquals(accountBianchi.getTransactionsCount(), 1);
    }
    ...
    public void testWithdrawFromATM() {
        ...
        Assertions.assertEquals(accountRossi.getBalance(), 500 - StrictBankAccount.ATM_TRANSACTION_FEE);
        Assertions.assertEquals(accountBianchi.getBalance(), 500 - StrictBankAccount.ATM_TRANSACTION_FEE);
    ...
    public void testChargeManagementFees() {
        ...
        Assertions.assertEquals(
            accountRossi.getBalance(), 
            1000 - (StrictBankAccount.MANAGEMENT_FEE + StrictBankAccount.TRANSACTION_FEE),
            0.0001
        );
        Assertions.assertEquals(
            accountBianchi.getBalance(),
            1000 - (StrictBankAccount.MANAGEMENT_FEE * 1 + StrictBankAccount.TRANSACTION_FEE)
        );
